/*
Replace all instances of a JSON element (based on key+value) across all paths inside a JSON document
====================================================================================================
Author: Eitan Blumin
Date: 2022-12-17
Description:
	...
	This specific variation of the function adds an additional constraint on the operation
	based on the VALUE of the element in question.
	In other words:
	Replace all instances of a specific element name that also have a specific value
...
DECLARE
	...
	, @jFilterByValue nvarchar(4000) = N'empty'
	, @jReplacementValue nvarchar(MAX) = N'new_item'

SELECT dbo.JSON_FindAndReplaceByNameAndValueInAllPaths(@JDoc, @jElementToFind, @jFilterByValue, @jReplacementValue) AS NewValue

*/
CREATE FUNCTION dbo.JSON_FindAndReplaceByNameAndValueInAllPaths
(
	  @JDoc nvarchar(MAX)
	, @jElementToFind nvarchar(4000)
	, @jFilterByValue nvarchar(4000)
