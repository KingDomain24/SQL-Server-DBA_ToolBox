...
DECLARE
	 @IncludeDisabledConstraints bit = 0 -- change to 1 to also check for disabled constraints
...
+ CASE WHEN @IncludeDisabledConstraints = 1 THEN N'OR is_disabled = 1' ELSE N'AND is_disabled = 0' END + N'
